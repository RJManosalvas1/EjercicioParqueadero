...
// -----------------------------------------------------------------
    ...
    public String metodo3() {
        int cantidadConPB = contarCarrosQueComienzanConPlacaPB();
        boolean hayCarro24Horas = hayCarroCon24Horas();
        return "Cantidad de carros con placa PB: " + cantidadConPB + " – Hay carro parqueado por 24 o más horas: " + (hayCarro24Horas ? "Sí" : "No");
    }
    ...
    public String metodo4() {
        int cantidadSacada = desocuparParqueadero();
        return "Cantidad de carros sacados: " + cantidadSacada + ".";
    }
